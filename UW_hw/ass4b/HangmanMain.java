...
public class HangmanMain  {
    public static final String DICTIONARY_FILE = "E:\\Workspace\\IDEA\\Algorithm\\src\\main\\java\\ass4b\\dictionary.txt";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        HangmanManager2 hangman = new HangmanManager2(dictionary2, length, max);
    ...
    public static void playGame(Scanner console, HangmanManager2 hangman) {
    ...
    public static void showResults(HangmanManager2 hangman) {
