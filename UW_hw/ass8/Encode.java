...
public class Encode {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileInputStream input = new FileInputStream("E:\\Workspace\\IDEA\\Algorithm\\src\\main\\java\\ass8\\" + inFile);
        BitOutputStream output = new BitOutputStream("E:\\Workspace\\IDEA\\Algorithm\\src\\main\\java\\ass8\\" + outputFile);
        boolean done = false;
        int n = input.read();
        while (n != -1) {
            if (codes[n] == null) {
